...
CREATE TABLE `lxt_chat_friend_category` (
  ...
  `INSERT_TIME` datetime DEFAULT NULL,
  `UPDATE_TIME` datetime DEFAULT NULL,
  PRIMARY KEY (`FRIEND_CATEGORY_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Records of lxt_chat_group_user
-- ----------------------------
...
CREATE TABLE `lxt_chat_record` (
  ...
  KEY `FK_chatrecord_user` (`SEND_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `lxt_node` (
  ...
  `NODE_XML` text,
  PRIMARY KEY (`NODE_ID`),
  KEY `FK_Reference_4` (`WORKFLOW_ID`)
...
CREATE TABLE `lxt_process` (
  ...
  KEY `FK_WORKFLOW_CATEGORY_ID` (`PROCESS_CATEGORY_ID`)
...
-- ----------------------------
-- Records of lxt_process_category
-- ----------------------------
...
CREATE TABLE `lxt_user` (
  ...
  KEY `FK_USER_ORGANIZATION` (`ORG_ID`)
